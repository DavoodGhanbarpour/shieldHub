        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <div>
                        <input type="text" name="title" class="form-control" placeholder="{{__('app.servers.title')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div>
                        <input type="text" name="start_date" class="form-control datepicker"
                               placeholder="{{__('app.servers.start_date')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div>
                        <input type="text" name="end_date" class="form-control datepicker"
                               placeholder="{{__('app.servers.end_date')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4" id="twoInputsParent">
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3" id="inputParent">
                            ...
                            <div>
                                <input type="text" name="ip" class="form-control" placeholder="{{__('app.servers.ip')}}">
                            </div>
                        </div>
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <div>
                                <input type="text" name="subscription_price_per_month" class="form-control number_format" placeholder="{{__('app.servers.subscription_price_per_month')}}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <div>
                                ...
                                placeholder="{{__('app.servers.description')}}"></textarea>
                            </div>
                        </div>
                    </div>
                </div>
