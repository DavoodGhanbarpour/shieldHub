        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <div>
                        <input type="text" name="title" value="{{$inbound->title}}" class="form-control" placeholder="{{__('app.inbounds.title')}}">
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div>
                        <input type="text" name="date" value="{{$inbound->date}}" class="form-control datepicker" placeholder="{{__('app.inbounds.date')}}">
                    </div>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div>
                        <input type="text" name="link" class="form-control" placeholder="{{__('app.inbounds.link')}}" value="{{$inbound->link}}">
                    </div>
                </div>
                ...
                <div class="col-md-12 mb-3">
                    ...
                    <div>
                        <input type="text" name="description" class="form-control" placeholder="{{__('app.inbounds.description')}}" value="{{$inbound->description}}">
                    </div>
                </div>
